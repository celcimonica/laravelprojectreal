...
return new class extends Migration
{
    ...
    {
        Schema::table('detil_transaksis', function(Blueprint $table) {
            $table->dropForeign('detil_transaksis_transaksi_id_foreign');
        });
   
        Schema::table('detil_transaksis', function(Blueprint $table) {
            $table->dropIndex('detil_transaksis_transaksi_id_foreign');
        });

        Schema::table('detil_transaksis', function(Blueprint $table) {
            $table->dropForeign('detil_transaksis_layanan_id_foreign');
        });
   
        Schema::table('detil_transaksis', function(Blueprint $table) {
            $table->dropIndex('detil_transaksis_layanan_id_foreign');
        });
