...
<div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="dist/img/inumaki.png" alt="AdminLTELogo" height="200" width="200">
  </div>
<!-- Navbar -->
...
<li class="nav-item">
<a href="{{route('layanan.index')}}" class="nav-link {{($title==='layanan')?'active':''}}">
