...
wire:model="transaksi_id" value="{{ $data->id }}">
<div class="form-group">
<label for="layanan_id">layanan</label>
<select class="form-control"
wire:model="layanan_id" name="layanan_id">
<option hidden>--Pilih Layanan--
</option>
...
wire:model="qty" name="qty">
</div>
</div>
<!-- /.card-body -->
<div class="card-footer text-end">
<button type="submit" class="btn btn-successbtn-sm"><i class="fas fa-cart-plus"></i> Tambahkan</button>
</div>
</form>
</div>
</div>
...
wire:click="delete({{ $dt->id }})"><i class=" fas fa-trash"></i></a></td>
</tr>
@endforeach
</tbody>
</table>
...
<button class="btn btn-lg btn-success" wire:click="receipt({{ $data->id}})"><i class="fas
