        ...
        <form action="{{ route('pengguna.store') }}" method="POST">
            ...
            <div class=" card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="username" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="cekaii" required value="{{ old('username') }}">
                    @error('username')
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                        ...
                        <label for="nama">Pilih Gambar</label>
